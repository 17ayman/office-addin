...
function get_template_B_info(user_info) {
  ...
  str +=
    "<td style='border-right: 1px solid #000000; padding-right: 5px;'><img src='https://raw.githubusercontent.com/17ayman/office-addin/refs/heads/main/Edalo.png' alt='Logo' /></td>";
  str += "<td style='padding-left: 5px;'>";
  str += "<strong>" + user_info.name + "</strong>";
  str += is_valid_data(user_info.pronoun) ? "&nbsp;" + user_info.pronoun : "";
  str += "<br/>";
